            ...
            <form method="POST" action="../admin/gestionIndex.php?gestion=formation">
                ...
                <div class="form-group">
                    <select name="sgdate" class="form-control custom-select">
                        <option value="<?php echo $diplome_update['sgdate'] ??
                            $_POST['sgdate'] ?? 'Année' ?>"><?php echo $diplome_update['sgdate'] ?? $_POST['sgdate'] ?? 'Année' ?></option>
                        <?php
                        echo $select_date;
                        ?>
                    </select>
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="text" name="sgtitle" placeholder="Diplome" value="<?php echo $diplome_update['sgtitle'] ?? $_POST['sgtitle'] ?? '' ?>">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="text" name="sgsubtitle" placeholder="spécialité" value="<?php echo
                        $diplome_update['sgsubtitle'] ?? $_POST['sgsubtitle'] ?? '' ?>">
                </div>
                <div class="form-group">
                    <textarea name="sgdescription" id="" rows="5" placeholder="Description" class="form-control"><?php echo
                            $diplome_update['sgdescription'] ?? $_POST['sgdescription'] ?? '' ?></textarea>
                </div>
