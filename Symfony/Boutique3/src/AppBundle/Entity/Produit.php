...
class Produit
{
     ...
     */
    private $photo = 'defaut.jpg';


    // On ne mappe pas cette propriété,car elle n'est pas liée à la base de donnée,elle va simplement nous permettre de manipuler la(les) photos d'un produit afin de l'enregistrer.
    private $file;
     ...
     * @return Produit
     * 
     * L'objet UploadedFile de Symfony, nous permet de gérer tout ce qui est liée à un fichier uploadé ()
     */
