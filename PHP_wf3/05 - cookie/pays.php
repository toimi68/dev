...
<body>
    ...
    <h1 class=" display-4 text-center" span style="border-bottom: 4px dashed blue">COOKIE PHP</span></h1><hr>
        ...
        elseif(isset($_COOKIE['pays'])) // on entre dans le elseif dans le cas ou un cookie a été créer et que par exemple nous revenons sur le site 3 mois plus tard, la valeur du cookie sera afficher
        {
            $pays = $_COOKIE['pays'];
        }
        ...
        $un_an = 365*24*3600; //  correspond à une année en une seconde,ce qui sera la durée de vie du cookie.
        ...
        // 3 arguments : nom du cooki / valeur du cookie / durée de vie
        echo '<pre>'; print_r($_COOKIE); echo '</pre>';

        // un cookie est un fichier qui est conversé côté client , c'est à dire sur le pc du navigateur, il contient des données non sensibles ( derniers articles consultés, langue préféré du site etc...)
        ...
        switch($pays)
        {
            ...
            break;
            case 'es' : 
                echo "estas en un sitio de ingles<br>";
            break;
            case 'an' : 
                echo "you are on an English site<br>";
            break;
            case 'it' : 
                echo "sei su un sito inglese<br>";
            break;
        }
