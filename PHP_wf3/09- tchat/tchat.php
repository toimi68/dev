        ...
        <?php 
            ...
            foreach($_POST as $key => $value)
            {
             //$_POST['pseudo'] = strip_tags('<style></style>');
                $_POST[$key] = strip_tags($value); // on passe en revue le formulaire en executant la fonction strip_tags sur chaque valeur saisie dans le formulaire
            ...
            if($_POST)
            {
                ...
                $resultat->execute();
                 // ces ligners de code, la méthode prepare(), permet d'éviter les injections SQL des hackers
